    ...
    try:
        ...
        try:
            ...
            if m_site:
                ...
                if host:
                    _LAST_SITE_HOST[str(chat_id)] = host
        except Exception:
            pass
...
def _install_text_sanitizer_hooks():
    ...
    try:
        if _ORIG_SEND_TEXT is None and '_send_text' in globals() and callable(globals()['_send_text']):
            _ORIG_SEND_TEXT = globals()['_send_text']
            def __wrapped_send_text(chat_id, text, *args, **kwargs):
                try:
                    text = _postprocess_outgoing_text(text, chat_id)
                except Exception:
                    pass
                return _ORIG_SEND_TEXT(chat_id, text, *args, **kwargs)
    ...
    try:
        if _ORIG_SEND_HTML is None and '_send_html' in globals() and callable(globals()['_send_html']):
            ...
            def __wrapped_send_html(chat_id, html, *args, **kwargs):
                try:
                    html = _postprocess_report_html(html)
                except Exception:
                    pass
                return _ORIG_SEND_HTML(chat_id, html, *args, **kwargs)
